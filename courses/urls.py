...
from .views import kurslar, details, getCoursesByCategory, getCoursesByCategoryId


urlpatterns = [
    path('', kurslar),   # Hiçbir ek belirtilmediği taktirde: 127.0.0.1:8000/kurs olarak getir, yani varsayilan olarak bir sayfa belirttik.
